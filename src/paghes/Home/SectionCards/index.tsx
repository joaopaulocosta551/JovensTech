...
export const SectionCards = () => {
  const cards: ICard[] = [
    {
      ...
      style: {
        background:
          "linear-gradient(44.42deg, rgba(191, 44, 78, 0.9) -12.5%, rgba(139, 31, 109, 0.9) 50.12%, rgba(73, 64, 157, 0.9) 108.75%)",
      },
    },

    {
      ...
      style: {
        background:
          "linear-gradient(44.11deg, rgba(109, 102, 172, 0.32) -8.48%, rgba(18, 105, 134, 0.32) 51.81%, rgba(71, 183, 163, 0.32) 108.75%)",
      },
    },
    {
      ...
      style: {
        background:
          "linear-gradient(44.63deg, rgba(71, 183, 163, 0.32) -12.5%, rgba(71, 191, 104, 0.32) 51.37%, rgba(247, 204, 0, 0.32) 111.16%, rgba(247, 204, 0, 0.32) 111.16%)",
      },
    },
  ];
  ...
  return (
    <section
      ...
      <SubTitle>Por que participar do Jovens Tech?</SubTitle>
      <Cards>
        {cards.map((card) => {
          return (
